...
class Test_list_to_multikey(unittest.TestCase):
    ...
    def test_lhs_str_and_rhs_str(self):
        ...
        r = esm_parser.list_to_multikey(
            ["echam", "[[streams-->STREAM]]"], "restart_${expid}_STREAM.nc", tdict
        )
        self.assertEqual(
            r,
            {
    ...
    def test_lhs_str_and_rhs_list_nostr_rhs(self):
        ...
        r = esm_parser.list_to_multikey(
            ["echam", "[[streams-->STREAM]]"], [True, 1], tdict
        )
    ...
    def test_rhs_str_and_rhs_list_fence(self):
        ...
        r = esm_parser.list_to_multikey(
            ["echam", True], "file_[[streams-->STREAM]].nc", tdict
        )
    ...
    def test_rhs_str_and_rhs_list_fence_double_list(self):
        ...
        r = esm_parser.list_to_multikey(
            ["echam", True], "file_[[streams-->STREAM]][[streams-->OTHER]].nc", tdict
        )
        expected_answer = [
            "file_aa.nc",
            "file_ab.nc",
    ...
    def test_rhs_not_str(self):
        tdict = {"echam": {42: 42}}
        r = esm_parser.list_to_multikey(["echam", 42], 42, tdict)
        self.assertEqual(r, 42)

    def test_lhs_bool(self):
        tdict = {"echam": {"forcing": {True: "lala"}}}
        r = esm_parser.list_to_multikey(["echam", "forcing", True], "lala", tdict)
